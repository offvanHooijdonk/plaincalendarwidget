...
public class CalendarDataSource {
    ...
    public Maybe<List<CalendarModel>> requestCalendarList() {
        return Maybe.fromCallable(this::loadCalendars);
    }

    private List<CalendarModel> loadCalendars() {
        ...
        try (Cursor cur = prepareCalendarsCursor(cr, uri)) {
            while (cur != null && cur.moveToNext()) {
                CalendarModel bean = new CalendarModel();
    ...
    public List<EventModel> getEvents(List<CalendarModel> calendars, int daysAhead) {
    ...
    private Cursor prepareEventsCursor(ContentResolver cr, List<CalendarModel> calendars, int daysAhead) {
    ...
    private String[] prepareEventsArgs(List<CalendarModel> calendars) {
