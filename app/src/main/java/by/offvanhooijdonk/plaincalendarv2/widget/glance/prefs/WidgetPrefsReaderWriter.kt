...
private const val KEY_EVENT_COLOR_SHAPE = "key_event_color_shape"
...
private val keyEventColorShape = stringPreferencesKey(KEY_EVENT_COLOR_SHAPE)
...
fun WidgetModel.writeToPrefs(prefs: MutablePreferences) {
    ...
    prefs[keyEventColorShape] = eventColorShape.name
